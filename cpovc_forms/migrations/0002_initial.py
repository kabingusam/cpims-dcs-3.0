...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ovcprogramregistration',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cpovc_auth.appuser'),
        ),
        migrations.AddField(
            model_name='ovcprogramregistration',
            name='person',
        ...
        migrations.AddField(
            ...
            name='app_user',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='cpovc_auth.appuser'),
        ),
        migrations.AddField(
            model_name='ovccaseevents',
            name='case_id',
